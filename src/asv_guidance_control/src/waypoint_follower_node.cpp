#include "asv_guidance_control/waypoint_follower_node.hpp"
#include <cmath>
#include <chrono>
...
: rclcpp::Node("waypoint_follower_node")
{
  ...
  waypoint_sub_ = this->create_subscription<asv_msgs::msg::Waypoint>(
    "/asv/active_waypoint", 10,
    std::bind(&WaypointFollowerNode::waypointCallback, this, std::placeholders::_1));

  cmd_pub_ = this->create_publisher<geometry_msgs::msg::Twist>(
    "/mavros/setpoint_velocity/cmd_vel_unstamped", 10);
  status_pub_ = this->create_publisher<asv_msgs::msg::MissionStatus>(
...
void WaypointFollowerNode::waypointCallback(const asv_msgs::msg::Waypoint::SharedPtr msg)
{
