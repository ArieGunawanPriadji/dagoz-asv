#ifndef ASV_GUIDANCE_CONTROL__WAYPOINT_FOLLOWER_NODE_HPP_
#define ASV_GUIDANCE_CONTROL__WAYPOINT_FOLLOWER_NODE_HPP_
...
private:
  ...
  void waypointCallback(const asv_msgs::msg::Waypoint::SharedPtr msg);
  void controlLoop();
  ...
  std::optional<asv_msgs::msg::Waypoint> active_waypoint_;
  sensor_msgs::msg::NavSatFix current_gps_;

  rclcpp::Subscription<sensor_msgs::msg::NavSatFix>::SharedPtr gps_sub_;
  rclcpp::Subscription<asv_msgs::msg::Waypoint>::SharedPtr waypoint_sub_;
...
#endif  // ASV_GUIDANCE_CONTROL__WAYPOINT_FOLLOWER_NODE_HPP_
